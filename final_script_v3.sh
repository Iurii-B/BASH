...
# Function to check if sysstat is installed in the system.
...
PARSED_ARGUMENTS=$(getopt -a -n systemmonitor -o hloac:d:m:n:p:k: --long help,loadaverage,auth,output,cpu:,proc:,memory:,disks:,network:,kill: -- "$@")
